# Skill: X/Twitter Publishing

## Purpose
Publish an approved draft to X/Twitter via the official API v2.
...
## Required Tools
- XPublishTool (HIGH risk, requires_approval=True)
- VerificationTool

## Required Permissions
- HIGH risk — REQUIRES explicit user approval before execution
- Requires X OAuth2 authentication
...
## Examples
- "Publish the approved PostgreSQL tips post to X"
