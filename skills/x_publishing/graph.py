...
_SYSTEM_PROMPT = """\
You are the X/Twitter Publishing skill for Agent Operator.

Your job: publish an explicitly pre-approved draft to X/Twitter and confirm
...
_TOOL_NAMES = ["social_publish_x", "social_verify"]
